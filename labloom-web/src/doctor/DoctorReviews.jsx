...
export default function DoctorReviews() {
    ...
    useEffect(() => {
        if (user?._id) {
            api.get(`/api/feedback/${user._id}?targetType=doctor`)
            ...
            <div className="main-content">
                ...
                <div className="page">
                    <div className="page-header">
                        ...
                        <p>See what your patients are saying about your service</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="empty-state">
                            ...
                            <p>Patient reviews will appear here after they complete consultations.</p>
                        </div>
                    )}
                </div>
            </div>
